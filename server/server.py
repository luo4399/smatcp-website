...
Usage:
    ...
    python /media/Rome/home/luodl/website/smatcp-website/server/mutation_annotation.py \
        --file-type txt \
        --input /media/Rome/home/luodl/website/smatcp-website/server/examples/test_mutation.txt \
...
PROJECT_DIR = os.path.dirname(SCRIPT_DIR)                        # 项目根（静态资源在这）
SRC_DIR = os.path.join(PROJECT_DIR, "src")                       # 页面目录
EXAMPLES_DIR = os.path.join(SCRIPT_DIR, "examples")              # 示例输入
